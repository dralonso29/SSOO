...
#include <err.h>
/*
si s1 es un char *, podemos hacer: p = strdup(s1) y luego hacemos free, o sino hacemos char b[MAX_LEN], y luego strncpy(b, s1, MAX_LEN)
*/

/*
	gcc -c -g -Wall -Wshadow anagrams.c
	gcc -o anagrams anagrams.o
	./anagramas hola perola aloh pelora tras tiki polera
*/
